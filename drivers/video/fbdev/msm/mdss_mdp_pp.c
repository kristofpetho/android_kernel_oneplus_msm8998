...
#define PP_EARLY_PROGRAM_DIRTY_MASK (PP_FLAGS_DIRTY_PCC | PP_FLAGS_DIRTY_ENHIST | PP_FLAGS_DIRTY_HIST_COL)
#define PP_DEFERRED_PROGRAM_DIRTY_MASK (PP_FLAGS_DIRTY_IGC | \
				PP_FLAGS_DIRTY_PGC | PP_FLAGS_DIRTY_ARGC | PP_FLAGS_DIRTY_GAMUT | PP_FLAGS_DIRTY_PA | \
